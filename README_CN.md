...
* 2025.03.26: 我们发布了 [Qwen2.5-Omni](https://huggingface.co/Qwen/Qwen2.5-Omni-7B). 对于更多的信息请访问我们的[博客](https://qwenlm.github.io/zh/blog/qwen2.5-omni/)!
...
| [视频信息提取](https://github.com/QwenLM/Qwen2.5-Omni/blob/main/video_information_extracting.ipynb) | 从视频流中获取信息。 | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://github.com/QwenLM/Qwen2.5-Omni/blob/main/video_information_extracting.ipynb) |
...
无需部署，您可以直接访问我们的 [Hugginface Spaces](https://huggingface.co/spaces/Qwen/Qwen2.5-Omni-7B) 和 [Modelscope 创空间](https://modelscope.cn/studios/Qwen/Qwen2.5-Omni-Demo) 来直接体验在线网页演示。
